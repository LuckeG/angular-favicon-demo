...
function _performApiRequest2(_0, _1, _2, _3) {
  return __async(this, arguments, function* (auth, method, path, request, customErrorMap = {}) {
    return _performFetchWithErrorHandling2(auth, customErrorMap, () => __async(this, null, function* () {
      ...
      return FetchProvider2.fetch()(_getFinalTarget2(auth, auth.config.apiHost, path, query), Object.assign({
        method,
        headers,
      ...
      return new Promise((resolve, reject) => {
        retrieveSiteKey(this.auth).then((siteKey) => {
          if (!forceRefresh && isEnterprise2(window.grecaptcha)) {
            ...
            _loadJS2(RECAPTCHA_ENTERPRISE_URL + siteKey).then(() => {
              retrieveRecaptchaToken(siteKey, resolve, reject);
            }).catch((error) => {
              reject(error);
            });
...
var AuthImpl2 = class {
  ...
  initializeRecaptchaConfig() {
    return __async(this, null, function* () {
      const response = yield getRecaptchaConfig2(this, {
        clientType: "CLIENT_TYPE_WEB",
        version: "RECAPTCHA_ENTERPRISE"
        /* RecaptchaVersion.ENTERPRISE */
      });
      ...
      if (config.emailPasswordEnabled) {
        const verifier = new RecaptchaEnterpriseVerifier2(this);
        void verifier.verify();
      }
    });
  }
      ...
      switch (this.signInMethod) {
        case "password":
          ...
          if ((_a = auth._getRecaptchaConfig()) === null || _a === void 0 ? void 0 : _a.emailPasswordEnabled) {
            ...
            return signInWithPassword2(auth, requestWithRecaptcha);
          } else {
            return signInWithPassword2(auth, request).catch((error) => __async(this, null, function* () {
              if (error.code === `auth/${"missing-recaptcha-token"}`) {
...
var OAuthProvider2 = class _OAuthProvider extends BaseOAuthProvider2 {
  ...
  _credential(params) {
    ...
    return OAuthCredential2._fromParams(Object.assign(Object.assign({}, params), {
      providerId: this.providerId,
...
function sendPasswordResetEmail2(auth, email, actionCodeSettings) {
  return __async(this, null, function* () {
    ...
    if ((_a = authInternal._getRecaptchaConfig()) === null || _a === void 0 ? void 0 : _a.emailPasswordEnabled) {
      const requestWithRecaptcha = yield injectRecaptchaFields2(authInternal, request, "getOobCode", true);
...
function signInWithEmailAndPassword2(auth, email, password) {
  return signInWithCredential2(getModularInstance(auth), EmailAuthProvider2.credential(email, password));
}
...
function _iframeCannotSyncWebStorage() {
  const ua = getUA();
  return _isSafari2(ua) || _isIOS2(ua);
}
...
var MockWidget = class {
  constructor(containerOrId, appName, params) {
    ...
    _assert2(container, "argument-error", {
      appName
    });
    this.container = container;
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      if ("session" in phoneInfoOptions) {
        ...
        const {
          sessionInfo
        } = yield sendPhoneVerificationCode2(auth, {
          phoneNumber: phoneInfoOptions.phoneNumber,
          recaptchaToken
        });
        return sessionInfo;
...
function updatePhoneNumber2(user3, credential) {
  return __async(this, null, function* () {
    yield _link$12(getModularInstance(user3), credential);
  });
}
...
function loadGapi(auth) {
  return new Promise((resolve, reject) => {
    ...
    if ((_b = (_a = _window2().gapi) === null || _a === void 0 ? void 0 : _a.iframes) === null || _b === void 0 ? void 0 : _b.Iframe) {
      ...
      return _loadJS2(`https://apis.google.com/js/api.js?onload=${cbName}`).catch((e) => reject(e));
    }
  }).catch((error) => {
...
var TotpMultiFactorGenerator2 = class {
  ...
  static generateSecret(session) {
    return __async(this, null, function* () {
      ...
      const response = yield startEnrollTotpMfa2(mfaSession.auth, {
        idToken: mfaSession.credential,
        totpEnrollmentInfo: {}
      });
      return TotpSecret2._fromStartTotpMfaEnrollmentResponse(response, mfaSession.auth);
    });
  }
};
...
@firebase/auth/dist/esm2017/index-e3d5d3f4.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JBKE3U26.js.map
